class CalendarModule {
    ...
    createEventBox = (info) => {
        ...
        appointments.forEach(appointment => {
            var eventContainer = $('<div>').appendTo(this.modalContent).addClass('flex flex-col border-2 border-dark-900 shadow-md px-4 py-2 w-fit');
            ...
            $('<h2>').text(`Poznámka: ${appointment.message}`).appendTo(eventContainer);
        })
